		...
		return (
			<View style={{ flex: 1, backgroundColor: 'white', flexDirection: 'row', margin: 10 }}>
				...
				<View style={{ flex: 1, padding: 10 }}>
					...
					>
						<Text onPress={this.setState.counter} style={{  fontWeight: 'bold', bottom: 12, marginHorizontal:40, right:15 }}>
							Add to cart
						</Text>
					</TouchableOpacity>
				</View>
		...
		return (
			<View style={{ marginBottom: 70 }}>
				<View style={Cart_Screen.Container}>
					...
					<View style={Cart_Screen.Cart_Icon_View}>
						<ShoppingCartIcon {...this.props} />
					</View>
				</View>
...
export default connect(ReducersProps, ReducersActions)(Products);
