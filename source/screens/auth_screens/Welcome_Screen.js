				...
				>
					<ScrollView>
						<View style={styles.heading_View}>
							<Text style={styles.heading_Text}>Welcome to Dyno</Text>
						</View>

						<View style={styles.info_View}>
							<Text style={styles.info_Text}>Place your order just a tap away</Text>
						</View>

						<View style={styles.details_View}>
							<Text style={styles.details_Text}>Get Profesional & Quality Services</Text>
						</View>
